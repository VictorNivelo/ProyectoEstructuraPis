 ...
 * @author romer
 */
public class VistaTutorias extends javax.swing.JFrame {

    /**
     * Creates new form VistaTutorias
     */
    public VistaTutorias() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaTutorias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaTutorias().setVisible(true);
            }
        });
    }
